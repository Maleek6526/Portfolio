...
import profileImg from "../assets/WhatsApp Image 2025-09-14 at 20.47.29_c02bb8bd.jpg";

export default function About() {
  return (
    <section className="min-h-screen flex flex-col lg:flex-row items-center justify-center px-4 sm:px-8 md:px-16 py-12 sm:py-16 md:py-20 
      ...
      >
        ...
        >
          <p className="text-base sm:text-lg leading-relaxed text-slate-700 dark:text-slate-300">
            I'm <span className="font-bold text-indigo-600 dark:text-indigo-400">Adewale Maleek Ayobami</span>, a passionate full-stack engineer 
            who loves crafting interactive and scalable <span className="text-yellow-600 dark:text-yellow-400 font-semibold">web</span> and <span className="text-yellow-600 dark:text-yellow-400 font-semibold">mobile</span> experiences.  
            I specialize in <span className="text-yellow-600 dark:text-yellow-400 font-semibold">lightning-fast frontends</span>, <span className="text-yellow-600 dark:text-yellow-400 font-semibold">scalable backend services</span>, and <span className="text-yellow-600 dark:text-yellow-400 font-semibold">databases</span> — with a 
            creative eye for UI and problem-solving mindset.
          </p>
          <p className="mt-4 text-sm sm:text-base text-slate-600 dark:text-slate-400">
            Outside coding, I explore design, animations, and innovative solutions 
            that make technology fun and accessible.
          </p>
        </motion.div>
